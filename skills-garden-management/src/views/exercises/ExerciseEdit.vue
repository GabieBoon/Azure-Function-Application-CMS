...
export default {
    ...
    methods: {
        getOefening() {
            axios
                .get("/exercises/" + this.exerciseId)
                .then((response) => {
                    this.loading = false;
                    this.oefening.name = response.data.name;
                    this.oefening.media = response.data.media;
                    this.oefening.requirements = response.data.requirements;
                    this.oefening.steps = response.data.steps;
                    this.oefening.forms = response.data.forms;
                })
                .catch((error) => {
                    console.log(error);
                    this.loading = false;
